...
const HELP =
  "Open /start to choose an option.\n\n" +
  "Students can link an account, view their record, and update contact details. Authorised staff can create, edit, and list records.";
